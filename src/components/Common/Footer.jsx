    ...
    return (
        <div className='bg-black text-gray-200'>
            <div className='lg:w-10/12 w-11/12 mx-auto'>
                <footer className="footer py-10 justify-between">
                    <div>
                ...
                <footer className="footer  py-4 border-t border-base-300">
                    <div className="items-center grid-flow-col">
                        <img className='w-6/12' src={logo} alt="" />
                        <p>Car Doctor <br />Providing reliable tech since 2022</p>
                    </div>
                    <div className="md:place-self-center md:justify-self-end">
                        <div className="grid grid-flow-col gap-4">
                            ...
                            <Link to=''><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current text-red-600"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"></path></svg></Link >
                        </div>
                    </div>
                </footer>
            </div>
