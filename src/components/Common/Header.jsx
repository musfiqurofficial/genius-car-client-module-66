...
import UserLottie from './login/lottie/UserLottie';
        ...
        <div className='bg-base-100 py-2 shadow-md sticky top-0 z-10'>
            <div className="navbar lg:w-10/12 w-11/12 mx-auto px-0">
                <div className="navbar-start">
                    ...
                    <Link to='/' className="btn btn-ghost hover:bg-white justify-start px-0"><img className='w-8/12' src={logo} alt="" /></Link>
                </div>
                ...
                <div className="navbar-end">
                    <div className="dropdown dropdown-end mr-3">
                        <label tabIndex={0} className="btn btn-ghost btn-circle">
                            <div className="indicator">
                                ...
                                <span className="badge badge-sm indicator-item bg-red-600 border-none">{orders.length}</span>
                    ...
                    <Link className="btn border-none bg-red-600 hover:bg-red-400 ml-5">Appointment</Link>
